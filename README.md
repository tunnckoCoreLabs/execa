...
This project requires [**Node.js**](https://nodejs.org) **>=10.13.0**. Install it using
...
**Params**
- `cmds` **{string|Array<string>}** a commands to execute, if array of strings executes them serially
